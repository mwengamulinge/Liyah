...
export const GALLERY_LOOKBOOK: GalleryItem[] = [
  ...
  {
    id: "g4",
    title: "Chic Knotless Bob",
    category: "bobs",
    style: "Smedium Knotless Bob with Sealed Ends",
    duration: "4.5 hrs",
    image: "/knotless-bob.png",
    caption: "Shoulder-length lightweight perfection framing the collarbone.",
    tag: "Bob Cut"
  },
  {
    id: "g5",
